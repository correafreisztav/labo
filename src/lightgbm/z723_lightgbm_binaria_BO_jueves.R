...
PARAM$trainingstrategy$undersampling  <-  0.8   # original 1.0 (un undersampling de 0.1  toma solo el 10% de los CONTINUA.) 
PARAM$trainingstrategy$semilla_azar   <- 131313  #Aqui poner la propia semilla

PARAM$hyperparametertuning$iteraciones <- 50 #original 10
PARAM$hyperparametertuning$xval_folds  <- 6 #original 5
PARAM$hyperparametertuning$POS_ganancia  <- 78000
PARAM$hyperparametertuning$NEG_ganancia  <- -2000

PARAM$hyperparametertuning$semilla_azar  <- 131313  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
