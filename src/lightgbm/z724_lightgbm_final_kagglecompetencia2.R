...
PARAM$finalmodel$learning_rate     <-      0.00502466256324092   #0.0142501265
PARAM$finalmodel$num_iterations    <-    328  #615
PARAM$finalmodel$num_leaves        <-   835  #784
PARAM$finalmodel$min_data_in_leaf  <-   7255  #5628
PARAM$finalmodel$feature_fraction  <-      0.737290070075691  #0.8382482539
